#Functions for aerosol and close contact modules; updated 5.25.2021
...
Aerofunc <- function(Event, room.exchange, Clean1, Clean2, Clean3, Clean4, Clean5, Clean6, Clean7, Clean8, Clean9, Clean10, Clean11, Clean12, sc.eff.p, Humidity, Infected.Mask, HW, Glove, Susceptible.Mask){
  ...
  #assuming 75ft2 + 25ft2 per person - should fit 10 people so total is 325ft2 or 30.1935m2
  facility.length <- 5.494861235736531
  facility.width <- 5.494861235736531
  facility.height <- 4.6
