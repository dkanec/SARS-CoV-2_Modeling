...
#RESIDENTIAL CODE AS OF MAY 25 2021
...
Aerofunc <- function(Event, room.exchange, Clean1, Clean2, Clean3, Clean4, Clean5, Clean6, Clean7, Clean8, Clean9, Clean10, Clean11, Clean12, sc.eff.p, Humidity, Infected.Mask, HW, Glove, Susceptible.Mask){
  ...
  facility.length <- 3.048
  facility.width <- 4.572
  facility.height <- 2.440
  ...
  v.decay.lh <- mcstoc(runif, type = "VU", min = 2.12765957, max = 3.44827586)
  v.decay.hh <- mcstoc(runif, type = "VU", min = 2.12765957, max = 3.44827586)
  ...
  ### surface area assumed to range from 1ft^2 to 4ft^2
  sstable.sa <- mcstoc(runif,type="V", min=0.092903, max=0.371612)
  ...
  #fomite GLASS viral decay (from NEJM van Doremalen et al 2020); note: converted from TCID50 to PFU to viral decay rate
  fomite.decay <- mcstoc(rtriang, type = "VU", min = 1/6.82, mode = 1/5.58, max = 1/4.72)
  ...
  #This is going to be for a glass surface (i.e. table) - also could change to granite
  f12.hh <- mcstoc(rnorm, type = "VU", mean = 0.673, sd = 0.25)
  f12.lh <- mcstoc(rnorm, type = "VU", mean = 0.193, sd = 0.132)
...
AeroSensfunc <- function(Event, room.exchange, Clean1, Clean2, Clean3, Clean4, Clean5, Clean6, Clean7, Clean8, Clean9, Clean10, Clean11, Clean12, sc.eff.p, Humidity, Infected.Mask, HW, Glove, Susceptible.Mask){
  ...
  AeroSens <- mc(log.C.virus, v2.50, coughfreq, E.virus, vs, room.exchange, U.avg, v.us, Ct2, f12.lh, f23, v.decay.min.hand, hand.sa, fingers.sa, freq.hs, freq.hf, hw.eff, sc.eff.p, v.decay, fomite.decay, DT.hh2, inhalerate, s.mask, s.mask.p, c.mask, oN95.mask, c.mask.p, oN95.mask.p, V.loss, u.star, Tw, Re, B, r.plus, D, Cc, Sc, A, I, Cf, dosetime2)
...
DoseSensfunc <- function(Event, Volume.Fraction, Distance, Vol.Frac.Dist.Name, room.exchange, Clean1, Clean2, Clean3, Clean4, Clean5, Clean6, Clean7, Clean8, Clean9, Clean10, Clean11, Clean12, sc.eff.p, Humidity, Infected.Mask, HW, Glove, Susceptible.Mask){
  ...
  DropSens <- mc(log.C.virus, coughfreq, v50.60, v60.100, v100.750, s.mask, s.mask.p, E.virus, room.exchange, V.loss, Ct2, f12.lh, c.mask, oN95.mask, c.mask.p, oN95.mask.p, f23, v.decay.min.hand, hand.sa, fingers.sa, freq.hs, freq.hf, hw.eff, sc.eff.p, v.decay, fomite.decay, inhalerate, dosetime2)
