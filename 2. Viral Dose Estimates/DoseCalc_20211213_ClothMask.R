...
ifelse(Module == "Transport", mask <- "cloth", mask <- "cloth")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Transportation_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Cloth Mask Dose/CarTransport.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Residential", mask <- "cloth", mask <- "cloth")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(ResCough_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Cloth Mask Dose/ResCough.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "ResBreath", mask <- "none", mask <- "cloth")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(ResBreath_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Cloth Mask Dose/ResBreath.csv", row.names = FALSE)
...
ifelse(Module == "Outdoor", mask <- "cloth", mask <- "cloth")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Outdoor_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Cloth Mask Dose/Outdoor.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Bus", mask <- "cloth", mask <- "cloth")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Bus_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Cloth Mask Dose/Bus.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Indoor", mask <- "cloth", mask <- "cloth")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Indoor_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Cloth Mask Dose/Indoor.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Break", mask <- "none", mask <- "cloth")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Break_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Cloth Mask Dose/Break.csv", row.names = FALSE)
