...
ifelse(Module == "Transport", i.HW <- "no", i.HW <- "yes")
...
#Increased ACH 
set.seed(12345)
ifelse(Module == "Transport" & IncACH == "yes", m.room.exchange <- mcstoc(runif, type = "V", min = 6.5, max = 51.7), 
...
write.csv(Transportation_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Packaged Dose/CarTransport.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Residential", i.HW <- "no", i.HW <- "yes")
...
write.csv(ResCough_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Packaged Dose/ResCough.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "ResBreath", i.HW <- "no", i.HW <- "yes")
ifelse(Module == "ResBreath", mask <- "none", mask <- "surgical")
i.index.mask<- mask
i.susceptible.mask<-mask
ifelse(Module == "ResBreath", i.Clean4 <- 0, i.Clean4 <- 1)
ifelse(Module == "ResBreath", i.Clean8 <- 0, i.Clean4 <- 1)
...
write.csv(ResBreath_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Packaged Dose/ResBreath.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Outdoor", i.HW <- "yes", i.HW <- "yes")
ifelse(Module == "Outdoor", mask <- "surgical", mask <- "surgical")
i.index.mask<- mask
i.susceptible.mask<-mask
ifelse(Module == "Outdoor", i.Clean4 <- 1, i.Clean4 <- 1)
ifelse(Module == "Outdoor", i.Clean8 <- 1, i.Clean4 <- 1)
...
write.csv(Outdoor_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Packaged Dose/Outdoor.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Bus", i.HW <- "no", i.HW <- "yes")
...
write.csv(Bus_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Packaged Dose/Bus.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Indoor", i.HW <- "yes", i.HW <- "yes")
...
write.csv(Indoor_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Packaged Dose/Indoor.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Break", i.HW <- "no", i.HW <- "yes")
...
write.csv(Break_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Packaged Dose/Break.csv", row.names = FALSE)
