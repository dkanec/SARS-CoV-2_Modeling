...
### Combined aerosol and close contact modules - oN95 Mask Model
### Code updated 3.16.2021
...
ifelse(Module == "Transport", mask <- "oN95", mask <- "oN95")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Transportation_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/N95 Mask Dose/CarTransport.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Residential", mask <- "oN95", mask <- "oN95")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(ResCough_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/N95 Mask Dose/ResCough.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "ResBreath", mask <- "none", mask <- "oN95")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(ResBreath_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/N95 Mask Dose/ResBreath.csv", row.names = FALSE)
...
ifelse(Module == "Outdoor", mask <- "oN95", mask <- "oN95")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Outdoor_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/N95 Mask Dose/Outdoor.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Bus", mask <- "oN95", mask <- "oN95")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Bus_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/N95 Mask Dose/Bus.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Indoor", mask <- "oN95", mask <- "oN95")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Indoor_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/N95 Mask Dose/Indoor.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Break", mask <- "none", mask <- "oN95")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Break_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/N95 Mask Dose/Break.csv", row.names = FALSE)
