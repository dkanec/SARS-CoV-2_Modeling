...
ifelse(Module == "Transport", mask <- "double", mask <- "double")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Transportation_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Double Mask Dose/CarTransport.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Residential", mask <- "double", mask <- "double")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(ResCough_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Double Mask Dose/ResCough.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "ResBreath", mask <- "none", mask <- "double")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(ResBreath_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Double Mask Dose/ResBreath.csv", row.names = FALSE)
...
ifelse(Module == "Outdoor", mask <- "double", mask <- "double")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Outdoor_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Double Mask Dose/Outdoor.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Bus", mask <- "double", mask <- "double")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Bus_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Double Mask Dose/Bus.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Indoor", mask <- "double", mask <- "double")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Indoor_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Double Mask Dose/Indoor.csv", row.names = FALSE)
...
#Fine Tune interventions
ifelse(Module == "Break", mask <- "none", mask <- "double")
i.index.mask<- mask
i.susceptible.mask<-mask
...
write.csv(Break_Module, "/Users/kane/Desktop/Leon Lab/Thesis/Manuscript/Code Files/Double Mask Dose/Break.csv", row.names = FALSE)
